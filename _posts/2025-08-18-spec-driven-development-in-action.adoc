...
.RA.Aid command running in the terminal, showing the AI planning and executing steps for the URL shortener.
...
.The final URL shortener application is running in a browser tab within Eclipse Che.
image::/assets/img/spec-driven-development-in-action/3-url-shortener-running.png[Final URL shortener application is running in a browser tab within Eclipse Che.]
